...
#define CONF_PRODUCT_ID 0x0504 /* 配置项目内显示的ProductID */
...
#define ROTARY_ENCODER_B 5 // 20
#define ROTARY_ENCODER_POS 3,4 // 正向旋转映射到键盘的按键行列（Row，Col）
#define ROTARY_ENCODER_NEG 3,6 // 负向旋转映射到键盘的按键行列（Row，Col）
...
static const uint8_t column_pin_array[MATRIX_COLS] = { 27, 28, 29, 30, 7, 12, 13, 16, 17, 18, 19, 10 };
