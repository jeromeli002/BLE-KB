...
#define CONF_PRODUCT_ID 0x0503 /* 配置项目内显示的ProductID */
#define DEVICE_VER 0x0001 /* 硬件版本 */
#define MANUFACTURER "JL" /* 硬件制造商，用于蓝牙显示 */
#define PRODUCT "JL-\u6570\u5b57\u952e\u76d8" /* 硬件名称，用于USB和蓝牙显示 */
...
// 启用 LED 状态灯
#define LED_STATUS_BLE 27// 蓝牙状态灯
//#define LED_STATUS_CHARGING 18// 充电状态灯
#define LED_STATUS_USB 27// USB状态灯
#define LED_BLE_CHANNEL1 27// 状态灯１
#define LED_BLE_CHANNEL2 6// 状态灯２
#define LED_BLE_CHANNEL3 10// 状态灯３
//#define LED_POSITIVE // LED上拉驱动

// 独立硬件按钮
#define POWER_BUTTON 12 // 3

// 旋钮配置
#define ROTARY_ENCODER_A 3 // 19
#define ROTARY_ENCODER_B 4 // 20
#define ROTARY_ENCODER_POS 5,2 // 正向旋转映射到键盘的按键行列（Row，Col）
#define ROTARY_ENCODER_NEG 5,4 // 负向旋转映射到键盘的按键行列（Row，Col）
...
static const uint8_t row_pin_array[MATRIX_ROWS] = { 24, 18, 17, 16, 15, 14 };
static const uint8_t column_pin_array[MATRIX_COLS] = { 23, 22, 13, 11, 5 };
